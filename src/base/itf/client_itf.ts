...
export type ClientAuthOption = AxiosRequestConfig & {
  ...
  requestChain: BaseClientServicesPluginChains<
    AxiosRequestConfig,
    AxiosRequestConfig,
    IBaseAuthClient<any, any, any>
  >[];
...
export abstract class IBaseClientResponsibilityChain {
  /** axios.interceptors.request 以責任鍊方式實作 */
  abstract requestChain: BaseClientServicesPluginChains<
    AxiosRequestConfig,
    AxiosRequestConfig,
    any
  >[];
...
export abstract class IBaseClientProperties<
  OPTION,
  QUEUE extends QueueRequest = QueueRequest
> {
...
//
//
export abstract class IBaseAuthClient<
  DATA,
  ERROR,
  SUCCESS,
  QUEUE extends QueueRequest = QueueRequest
> implements
    ...
    IBaseClientProperties<ClientAuthOption, QUEUE>
{
  abstract requestChain: BaseClientServicesPluginChains<
...
export abstract class IBaseClient<
  ...
  QUEUE extends QueueRequest = QueueRequest
> implements
    IBaseClientMethods<DATA, ERROR, SUCCESS>,
    IBaseClientResponsibilityChain,
    IBaseClientProperties<ClientOption<DATA, ERROR, SUCCESS>, QUEUE>
{
