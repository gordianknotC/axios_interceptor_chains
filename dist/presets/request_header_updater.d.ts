 ...
 * ```ts
  ...
  ```
 */
export declare class AuthRequestHeaderUpdater<RESPONSE, ERROR, SUCCESS> extends BaseRequestHeaderGuard<RESPONSE, ERROR, SUCCESS> {
    /** 使用者自定義 AuthToken 參照*/
    tokenGetter: () => string;
    constructor(
    /** 使用者自定義 AuthToken 參照*/
...
export declare class ExtraRequestHeaderUpdater<RESPONSE, ERROR, SUCCESS> extends BaseRequestHeaderGuard<RESPONSE, ERROR, SUCCESS> {
